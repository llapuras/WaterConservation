Shader "Toon/Lit Specular" {
	Properties {
		...
		_SpecSize("Specular Size", Range(0.01,1.999)) = 0.9 // specular size
			_SpecOffset("Specular Offset", Range(0.5,10)) = 0.5 // specular offset of the spec Ramp
	 _TColor("Gradient Overlay Top Color", Color) = (1,1,1,1)
      _BottomColor("Gradient Overlay Bottom Color", Color) = (0.23,0,0.95,1)
	  _Offset("Gradient Offset", Range(-4,10)) = 3.2 
...
#endif
	o.Albedo =dot((step(_SpecSize, rampS.r)) * rampS * d* _SColor, o.Normal); // specular
#if FADE
